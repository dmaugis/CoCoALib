...
namespace CoCoA
{
  ...
  {
    CoCoA_ERROR(ERR::ShouldNeverGetHere, "RingFpLogImpl::myRecvTwinFloat");
  }
...
// RCS header/log
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/RingFpLog.C,v 1.42 2018/05/18 12:22:30 bigatti Exp $
// $Log: RingFpLog.C,v $
