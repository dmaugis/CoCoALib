...
namespace CoCoA
{
  ...
  {
    CoCoA_ERROR(ERR::ShouldNeverGetHere, "RingFpDoubleImpl::myRecvTwinFloat");
  }
...
// RCS header/log
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/RingFpDouble.C,v 1.44 2018/05/18 12:22:30 bigatti Exp $
