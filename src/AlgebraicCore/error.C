...
namespace CoCoA
{
  ...
  std::ostream& ErrorInfo::myOutputSelf(std::ostream& out) const
  {
  ...
  {
#ifdef CoCoA_DEBUG
    VerboseLog VERBOSE("ThrowError");
    VERBOSE(10) << "CoCoA::error throwing " << err << endl;
#endif
    throw err;
  }
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/error.C,v 1.66 2018/04/18 14:14:08 abbott Exp $
// $Log: error.C,v $
