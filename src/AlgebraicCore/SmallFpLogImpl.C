...
namespace CoCoA
{
  ...
  SmallFpLogImpl::SmallFpLogImpl(SmallPrime p, GlobalSettings::ResidueSetting ResidueChoice):
      myModulusValue(ourCheckCtorArg(p)),
      myResiduesAreSymm(ResidueChoice==GlobalSettings::SymmResidues),
      myResidueUPBValue(ourCalcResidueUPB(myModulusValue)),
      myIterLimit(ourCalcIterLimit(myModulusValue)),
  ...
  bool SmallFpLogImpl::IsGoodCtorArg(SmallPrime p)
  {
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/SmallFpLogImpl.C,v 1.27 2018/06/25 12:28:21 abbott Exp $
