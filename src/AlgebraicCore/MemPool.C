...
//     const size_t MaxLoafBytes = 64*1024*1024; // We do not make any single loaf bigger than this.
    const size_t MinLoafBytes = 1024;    // First loaf is about this size; later ones are bigger.
    const size_t MaxLoafBytes = 64*1024; // We do not make any single loaf bigger than this.
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/MemPool.C,v 1.9 2017/12/01 17:30:30 bigatti Exp $
// $Log: MemPool.C,v $
