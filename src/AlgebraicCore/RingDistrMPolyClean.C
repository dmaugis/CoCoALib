...
namespace CoCoA
{
  ...
  SparsePolyRing NewPolyRing_DMP(const ring& CoeffRing, const std::vector<symbol>& IndetNames)
  {
    return NewPolyRing_DMP(CoeffRing,
                           NewPPMonoidEv(IndetNames, StdDegRevLex(len(IndetNames))));
  }
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/RingDistrMPolyClean.C,v 1.24 2018/05/22 14:16:40 abbott Exp $
