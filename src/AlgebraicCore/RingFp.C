...
namespace CoCoA
{
  ...
  {
    CoCoA_ERROR(ERR::ShouldNeverGetHere, "RingFpImpl::myRecvTwinFloat");
  }
...
// RCS header/log
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/RingFp.C,v 1.46 2018/05/18 12:15:56 bigatti Exp $
// $Log: RingFp.C,v $
