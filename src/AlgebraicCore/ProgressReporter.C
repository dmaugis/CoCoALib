...
namespace CoCoA
{
  ...
  bool ProgressReporter::myIsTimeToPrint()
  {
    ...
    myLastCheckTime = t;
    if (ratio >= 0.125) { decrease125(myCheckCount); }
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/ProgressReporter.C,v 1.6 2018/06/25 15:12:58 abbott Exp $
