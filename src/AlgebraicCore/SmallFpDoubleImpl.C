...
namespace CoCoA
{
  ...
  namespace // anonymous namespace
  {
	...
	cr += q*cm;
      ...
      if (r+m != 1) CoCoA_ERROR(ERR::DivByZero, "SmallFpDoubleImpl::myDiv");
      if (r == 0) return p-cm;
      return cr;
    }
  ...
  SmallFpDoubleImpl::SmallFpDoubleImpl(const MachineInt& n, GlobalSettings::ResidueSetting ResidueChoice):
  ...
  SmallFpDoubleImpl::SmallFpDoubleImpl(SmallPrime p, GlobalSettings::ResidueSetting ResidueChoice):
  ...
  bool SmallFpDoubleImpl::IsGoodCtorArg(SmallPrime p)
  {
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/SmallFpDoubleImpl.C,v 1.33 2018/06/25 12:28:21 abbott Exp $
