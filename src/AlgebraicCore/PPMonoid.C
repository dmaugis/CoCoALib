...
// ------------------------------ Arithmetic ------------------------------
  ...
  {
    if (exp < 0)
      CoCoA_ERROR(ERR::NegExp, "PowerOverflowCheck(pp, n) and n < 0");
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/PPMonoid.C,v 1.41 2018/05/18 12:15:04 bigatti Exp $
// $Log: PPMonoid.C,v $
