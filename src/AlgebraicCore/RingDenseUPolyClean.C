...
namespace CoCoA
{
  ...
  public:  // functions which every ring must implement
    ...
    void myAddMulLM(RawPtr rawf, ConstRawPtr rawc, long d, ConstRawPtr rawg) const;
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/RingDenseUPolyClean.C,v 1.40 2018/05/18 12:15:03 bigatti Exp $
