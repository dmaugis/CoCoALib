...
namespace CoCoA
{
  ...
  void program()
  {
    ...
    cout << "-- s is " << RingElem(Fpabc, s) << endl<< endl;
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/examples/ex-PolyInput2.C,v 1.10 2017/04/27 15:24:52 bigatti Exp $
