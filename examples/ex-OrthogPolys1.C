...
namespace CoCoA
{
  ...
  void program()
  {
    ...
    // We can also evaluate the polynomials by giving an second arg which
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/examples/ex-OrthogPolys1.C,v 1.1 2017/10/16 19:46:35 abbott Exp $
