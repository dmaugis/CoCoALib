...
const string LongDescription =
  ...
  "The guaranteed correct answer can be obtained by ";
//----------------------------------------------------------------------
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/examples/ex-VerificationLevel1.C,v 1.1 2018/03/14 15:29:27 abbott Exp $
