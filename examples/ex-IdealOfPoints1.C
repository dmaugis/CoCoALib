...
namespace CoCoA
{
  ...
  void program()
  {
    ...
    const ring& k = RingQQ();
    PolyRing P = NewPolyRing(k, DimOfSpace);
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/examples/ex-IdealOfPoints1.C,v 1.3 2017/07/08 19:07:02 abbott Exp $
