...
namespace CoCoA
{
  ...
  void program()
  {
    ...
    g.push_back(RingElem(P, "x[1]^3 * x[4]^4")); // easier like this ;-)
    g.push_back(RingElem(P, "x[1]^3 * x[5]^4"));
    g.push_back(RingElem(P, "x[3]^3 * x[6]^4"));
    g.push_back(RingElem(P, "x[3]^4 * x[6]^3"));
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/examples/ex-AlexanderDual.C,v 1.16 2017/04/27 15:24:52 bigatti Exp $
