...
namespace CoCoA
{
  ...
  void program()
  {
    ...
    try
    {
      const BigRat sum = SumOfReciprocals(50000, CpuTimeLimit(1.0));
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/examples/ex-CpuTimeLimit1.C,v 1.9 2018/05/25 09:24:45 abbott Exp $
